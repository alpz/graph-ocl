#built on resnet code from https://github.com/kuangliu/pytorch-cifar
...
class BasicBlockTranspose(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = nn.ConvTranspose2d(
            in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False, output_padding=output_padding)
        self.bn1 = nn.BatchNorm2d(planes)
...
class ResNetEncoder(nn.Module):
    def __init__(self):
        ...
        self.layer2 = self._make_layer(block, 100, num_blocks[1], stride=1)
        self.layer3 = self._make_layer(block, 100, num_blocks[2], stride=1)
        self.layer4 = self._make_layer(block, 100, num_blocks[3], stride=1)
...
class ResNetDecoder(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.ConvTranspose2d(64,4, kernel_size=3,
                               stride=1, padding=1, bias=False)
        #self.bn1 = nn.BatchNorm2d(64)
        ...
        #self.layer5 = self._make_layer(BasicBlock, 64, num_blocks[3], stride=1)
